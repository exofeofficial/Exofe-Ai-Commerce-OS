...
# Mirrors frontend/src/lib/plans.ts — keep the two in sync. Enterprise has
# no entry here on purpose: it's a negotiated deal activated by an admin
# with an explicit amount, not picked from this fixed price list.
PLAN_PRICES = {"free": 0, "launch": 1490, "grow": 3990, "scale": 9990}
