...
def get_messages_for_customer(db: Session, business_id: str, customer_id: str) -> list[dict]:
    rows = db.execute(
        text("""
            SELECT id, direction, content, message_type, ai_generated, created_at
            FROM whatsapp_message_logs
    ...
    row = db.execute(
        text("""
            INSERT INTO whatsapp_message_logs
                (business_id, customer_id, direction, content, message_type, ai_generated, whatsapp_message_id)
            VALUES (:business_id, :customer_id, :direction, :content, :message_type, :ai_generated, :whatsapp_message_id)
