...
def generate_structured(
    prompt: str, schema: type[BaseModel], *, image: tuple[bytes, str] | None = None
) -> BaseModel:
    """image, when given, is (raw bytes, mime type) — attached alongside the
    prompt so Gemini can see it (e.g. a screenshot the user attached)."""
