      ...
      >
        <div className="flex w-full max-w-3xl items-center gap-2">
          <nav className="flex min-w-0 flex-1 items-center gap-1 rounded-full border border-black/[.06] bg-white/95 py-1.5 pl-1.5 pr-2 shadow-lg shadow-black/[.06] backdrop-blur-md">
            {/* full wordmark below lg (more room to read "Exofe" than the
                round icon gives on a compact mobile pill), round icon-only
                logo from lg up where the nav links need the space back */}
            <Link
              href="/"
              aria-label="Exofe"
              className="flex shrink-0 items-center pl-1 lg:h-10 lg:w-10 lg:justify-center lg:overflow-hidden lg:rounded-full lg:pl-0"
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/logo-full.png" alt="Exofe" className="h-7 w-auto object-contain sm:h-8 lg:hidden" />
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/NAVlogo.jpg" alt="" className="hidden h-full w-full object-cover lg:block" />
            </Link>
