              ...
              >
                ...
                <div className="mt-4 flex items-end gap-1.5">
                  <span className="text-3xl font-extrabold tracking-tight text-foreground">
                    {plan.monthly === null ? "Custom" : `PKR ${plan.monthly.toLocaleString()}`}
                  </span>
                  {plan.monthly !== null && <span className="pb-1 text-xs text-foreground/45">/ month</span>}
                </div>
                ...
                >
                  {isCurrent ? "Current Plan" : plan.monthly === null ? "Contact us" : "Subscribe"}
                </button>
