...
export default function SettingsPage() {
  ...
  // Lets a link like /dashboard/settings?tab=developers land straight on
  // that tab — used by the developer portal's "Get your API key" CTA —
  // instead of always opening on Business Profile.
  const requestedTab = searchParams.get("tab");
  const initialTab = (TAB_IDS.includes(requestedTab ?? "") ? requestedTab : "profile") as TabId;
